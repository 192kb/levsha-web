...
export const TaskApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        uploadTaskImage: async (body?: any, options: any = {}): Promise<RequestArgs> => {
...
export const TaskApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async uploadTaskImage(body?: any, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TaskImage>> {
            const localVarAxiosArgs = await TaskApiAxiosParamCreator(configuration).uploadTaskImage(body, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const TaskApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        uploadTaskImage(body?: any, options?: any): AxiosPromise<TaskImage> {
            return TaskApiFp(configuration).uploadTaskImage(body, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class TaskApi extends BaseAPI {
     ...
     * @memberof TaskApi
     */
    public uploadTaskImage(body?: any, options?: any) {
        return TaskApiFp(this.configuration).uploadTaskImage(body, options).then((request) => request(this.axios, this.basePath));
    }
